...
public class Path {
    /// <summary>
    /// Przechowuje wierzchołki ścieżki
    /// </summary>
    [SerializeField] Node a, b;
    /// <summary>
    ...
    /// <summary>
    /// Przechouje maksymalną ilość pojazdów mogązych jednocześnie przebywać na ścieżce.
    /// </summary>
    ...
    /// </summary>
    [SerializeField] public readonly HidePath hide;
    /// <summary>
    /// Przechowuje referencje do ulicy, o ile do jakiejś należy
    /// </summary>
    [SerializeField] public readonly Street street;
    /// <summary>
    /// Przechowyje referencje do komponentu Transform, o ile go posiada
    /// </summary>
    [HideInInspector] public Transform transform;

    /// <summary>
    /// Zwraca identyfikator pierwszego wieżchołka
    /// </summary>
    public int IDOfA => a == null ? -1 : a.ID;
    /// <summary>
    /// Zwraca identyfikator drugiego wieżchołka
    /// </summary>
    public int IDOfB => b == null ? -1 : b.ID;
    /// <summary>
    /// Zwraca pozycje pierwszego wieżchołka
    /// </summary>
    public Vector3 PosOfA => a == null ? Vector3.zero : a.position;
    /// <summary>
    /// Zwraca pozycje drugiego wieżchołka
    /// </summary>
    public Vector3 PosOfB => b == null ? Vector3.zero : b.position;
    /// <summary>
    ...
    /// <summary>
    /// Metoda odpowiedzialna za wizualne przedstawienie obiektu
    /// </summary>
